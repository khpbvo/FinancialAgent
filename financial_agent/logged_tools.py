...
logged_list_recent_transactions = list_recent_transactions  # log_tool_calls(list_recent_transactions)
...
logged_update_goal_progress = update_goal_progress  # log_tool_calls(update_goal_progress)
logged_check_goals = check_goals  # log_tool_calls(check_goals)
logged_suggest_savings_plan = suggest_savings_plan  # log_tool_calls(suggest_savings_plan)
...
logged_analyze_subscription_value = analyze_subscription_value  # log_tool_calls(analyze_subscription_value)
logged_predict_next_recurring = predict_next_recurring  # log_tool_calls(predict_next_recurring)
logged_export_clean_monthly_recurring = export_clean_monthly_recurring  # log_tool_calls(export_clean_monthly_recurring)
...
logged_export_budget_report = export_budget_report  # log_tool_calls(export_budget_report)
logged_export_recurring_payments = export_recurring_payments  # log_tool_calls(export_recurring_payments)
logged_monthly_cost_summary = monthly_cost_summary  # log_tool_calls(monthly_cost_summary)
