...
class BudgetAdvice(BaseModel):
    ...
    savings_potential: Optional[float] = Field(description="Estimated monthly savings potential")
...
class SpendingAnalysis(BaseModel):
    ...
    unusual_transactions: Optional[List[Transaction]] = Field(description="Unusual or large transactions")
...
class FinancialSummary(BaseModel):
    ...
    expense_breakdown: List[CategorySpending] = Field(description="Breakdown by category")
