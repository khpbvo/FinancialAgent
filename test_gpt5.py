...
async def test_gpt5_reasoning():
    ...
    with build_deps() as deps:
        ...
        for i, test in enumerate(test_queries, 1):
            ...
            try:
                ...
                result = await Runner.run(agent, test["query"], context=deps)
    ...
    print(
        "The model will provide detailed, well-reasoned responses to financial queries."
    )
